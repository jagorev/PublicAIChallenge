...
class ColorazioneClassi:
    ...
    def __init__(self, iface):
        ...
        # Predizioni correnti (vuote inizialmente, verranno caricate dal modello)
    ...
    def run(self):
        ...
        # Chiedi all'utente di selezionare un file CSV con i dati dell'immobile
        csv_path, _ = QFileDialog.getOpenFileName(
            None,
            "Seleziona file CSV con i dati dell'immobile",
            "",
        ...
        try:
            self.predizioni_correnti = self.esegui_inferenza(csv_path)
        ...
        self.dialog = PredictionDialog(self.predizioni_correnti)
    ...
    def esegui_inferenza(self, csv_path):
        ...
        Returns:
            Lista di dizionari con categoria e probabilità nel formato:
    ...
    def applica_colorazione(self, layer):
        ...
        top_2_predizioni = predizioni_sorted[:5]
